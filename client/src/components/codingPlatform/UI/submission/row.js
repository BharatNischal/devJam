    ...
    return (
        <React.Fragment>
            <div className="row py-3" style={{borderBottom:"1px solid #c1c1c1"}} >
                <div className="col-2"> {props.index} </div>
                
                <div className="col-6"> {props.points} </div>
    <div className="col-4 pointer hover-pink" onClick={()=>setViewCode(!viewCode)} > <b> {viewCode?"Hide":"View"} Code</b>  </div>
