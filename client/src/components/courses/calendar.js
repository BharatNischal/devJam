...
function Calendar(props) {
    ...
    for(let i=1;i<=42;i++){
        if(i<start){
            ...
            days.push((<DateEl date={date} setVideoAlert={props.setVideoAlert} month={props.month} setDeliverableAlert={props.setDeliverableAlert} setEventAlert={props.setEventAlert} setTestAlert={props.setTestAlert} data={props.events[date]} setEventModal={props.setEventModal} isStudent={props.isStudent} ></DateEl>));
        }else{
